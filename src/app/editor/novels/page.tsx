...
export default async function EditorNovelsPage() {
  ...
  return (
    <div>
      <div className="mb-6 flex items-center justify-between">
        <h1 className="font-display text-2xl font-bold text-paper">Миний новелууд</h1>
        <Link
                ...
                <td className="px-4 py-3">
                  <div className="flex justify-end gap-2">
                    ...
                    <DeleteButton
                      ...
                      confirmText={`"${novel.title}"-ийг устгах уу?`}
                    />
                  </div>
                </td>
              </tr>
